...
public class JsonGenerator_nomut extends Generator<String> {

    public JsonGenerator_nomut() {
        super(String.class);
    }
    ...
    private String mutateStringRandomly(String input, SourceOfRandomness random) {
